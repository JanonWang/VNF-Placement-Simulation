...
/**
 * Created by Janon Wang on 2017/2/25.
 */
public class HeuristicVNFPlacementSameRack implements VNFPlacement{
    ...
    public HeuristicVNFPlacementSameRack(Topology topo, double para1, double para2, double para3) {
        this.topo = topo;
